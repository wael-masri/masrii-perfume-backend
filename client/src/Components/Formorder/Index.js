...
const Formorder = (props) => {
  ...
  if(props.arrayitem.length > 0){
    const storedClicks = await JSON.parse(localStorage.getItem('account_masriparfume'));
    ...
    return (
         ...
         <Formik
              ...
              >
                <Form>
                  {isLogin() === false &&
                  <h3 style={{textAlign:"center"}}>PLEASE LOGIN TO COMPLETE THE ORDER..</h3>}
                { isLogin() && <>
        <div className="container">
            <div className="row">
                <div className="col-md-6 div_desc_order">
                    <p className="p_desc_order">
                    You have chosen {props.totalquantity} of our products at a price of ${props.totalprice}.<br />
                    If you want to change, you can<span style={{color:"#a07d5a"}}> go back now.</span>
                    </p>
                </div>
            ...
            <Field type="number" name="phone" placeholder="Enter your number" className="form-control" />
            <ErrorMessage
                            component="div"
                            name="phone"
                            className="erorr"
            ...
            <Field type="text" name="shippingorder" placeholder="Enter your address" className="form-control" />
            <ErrorMessage
                            component="div"
                            name="shippingorder"
                            className="erorr"
            ...
            render={({ field }) => <textarea {...field}  className="form-control" rows={4} > </textarea>}
            />
            ...
            <div className="col-md-12">
                <button className="btn btn_finalorder mt-3" type="submit">Place Order</button>
            </div>
