...
useEffect(() => {
  ...
  const submitform = async (e) => {
   ...
   return (
    ...
    <Headeradmin title="Edit Post" path="/admin/posts" from="Posts" to="Edit"/>
        <div className="container">
            <div className="row">
                <div className="col-md-12">
                    <h3 style={{letterSpacing:"2px",marginTop:'20px'}}>Category <ArrowForwardIosIcon />
                     <span style={{color:'#a07d5a'}}>{props.location.state.brand}</span></h3>
                </div>
              ...
              {file === null && (
                <img src={DB + props.location.state.image_link} style={{ width: "100%", height: "419px" }} />
              )}
              <div className="row">
